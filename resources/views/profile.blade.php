...
<body>
    <style>
        ...
        /* Ensure the profile section is responsive and aligned */
        .profile {
            max-width: 1200px;
            margin: 0 auto;
            padding: 20px;
    ...
    <header class="header">
        <nav class="header__content">
            <div class="header__buttons">
                ...
                <a href="{{ route('dashboard') }}" class="header__home">
    ...
    <div class="profile">
        <div class="profile-header">
            <img class="profile-img" src="{{ $user->profile_picture ?? 'https://via.placeholder.com/100' }}" alt="Profile Picture">
            <div class="profile-info">
                <h3>{{ $user->name }}</h3>
                <div class="profile-stats">
                    <div><strong>{{ $postsCount }}</strong><br>posts</div>
                    <div><strong>{{ $user->followers_count ?? 0 }}</strong><br>followers</div>
                    <div><strong>{{ $user->following_count ?? 0 }}</strong><br>following</div>
                </div>
            </div>
        </div>
        <div class="bio-section">
            <p class="bio">📷 Photographer | 🌍 Traveler | 💻 Web Developer</p>
        </div>
    ...
    <!-- Media Section -->
   <!-- Example Blade template for displaying images -->
<div class="post__medias">
    @foreach($postMedias as $media)
        <img class="post__media" src="{{ asset('storage/' . $media) }}" alt="Post Media">
    @endforeach
</div>
